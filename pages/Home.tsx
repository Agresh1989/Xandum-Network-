        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
            ...
            <div className="space-y-8 text-center lg:text-left animate-fade-in-up order-2 lg:order-1">
                ...
                <p className="text-lg sm:text-xl text-slate-300 leading-relaxed max-w-lg mx-auto lg:mx-0 font-light">
                    The next evolution of blockchain infrastructure is here. Monitor pNodes, analyze storage metrics, and visualize network consensus with <span className="text-white font-semibold">AI Intelligence</span>.
                </p>
          ...
          <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
                  ...
                  <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 hover:border-purple-200 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
                      ...
                      <p className="text-slate-500 leading-relaxed">
                          Integrated AI reasoning engine analyzes network anomalies, generates natural language health reports, and predicts potential bottlenecks.
                      </p>
                  </div>
