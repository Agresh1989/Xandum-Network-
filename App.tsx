...
// Layout Wrapper to handle Sidebar logic and persistence
const AppLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
        ...
        {/* Sidebar & Mobile Header (Hidden on Home) */}
        {!isHome && (
          <>
        ...
        {/* Main Content Area */}
        <main className={`${!isHome ? 'lg:ml-64 p-4 lg:p-8' : ''} min-h-screen transition-all duration-300`}>
